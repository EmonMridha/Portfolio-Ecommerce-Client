                ...
                axiosSecure.put('/users', userData)
                    .then((response) => {
                        if (response.data.upsertedId) {
                            ...
                            Swal.fire('Google Sign-In Successful but User Data Already Exists', '', 'info');
                        }
        ...
        <main className="w-full h-screen flex flex-col items-center justify-center bg-amber-50 px-4">
            <div className="max-w-sm w-full text-gray-600 space-y-5">
                <div className="text-center pb-8">
                    <Link to='/'><p className='text-orange-500 hover:bg-orange-200  text-5xl rounded-full font-bold'> NextShop</p></Link>
                    <div className="mt-5">
